...
import br.futurodev.jmt.m2s10ex.servicos.UsuarioService;
...
public class UsuarioController {
    ...
    @GetMapping("{id}")
    public UsuarioRespostaDto getId(@PathVariable Long id) {
    ...
    @PutMapping("{id}")
    public UsuarioRespostaDto put(
            @PathVariable Long id,
            @RequestBody UsuarioRequisicaoDto dto
    ) {
